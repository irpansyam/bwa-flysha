...
export default function LoadingFlightDetail() {
    return (
        <div className="flex flex-col items-center gap-[30px] mt-[61px] pb-[30px]">
            <Skeleton className='w-[300px] h-8 bg-white' />
            <div className="flex flex-col items-center gap-[30px] w-[335px]">
                <div className="flex flex-col gap-[10px] w-full">
                    ...
                    <div className="flex justify-between">
                        <div className="flex flex-col gap-[2px] text-center">
                            <Skeleton className='w-[60px] h-5 bg-white' />
                            <Skeleton className='w-[40px] h-4 bg-white' />
                        </div>
                        <div className="flex flex-col gap-[2px] text-center">
                            <Skeleton className='w-[60px] h-5 bg-white' />
                            <Skeleton className='w-[40px] h-4 bg-white' />
                ...
                <div className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col gap-[2px]">
                            ...
                            <Skeleton className='w-[150px] h-5 bg-white'/>
                        </div>
                ...
                <div className="flex flex-col gap-[10px] w-full">
                    <div className="flex justify-between">
                        <span>Date</span>
                        <Skeleton className='w-[60pd] h-5 bg-white' />
                    </div>
                    <div className="flex justify-between">
