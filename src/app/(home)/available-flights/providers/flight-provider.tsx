...
import React, { Children, createContext, Dispatch, useReducer, type FC, type ReactNode } from 'react'
...
function filterReducer(state: FilterState, action: FilterAction): FilterState {
  ...
  switch (type) {
    case FilterActionKind.ADD_PLANE:
      return { ...state, planeIds: [...state.planeIds, payload.planeId] }
    case FilterActionKind.REMOVE_PLANE:
      return { ...state, planeIds: state.planeIds.filter((item) => item !== payload.planeId) }
    case FilterActionKind.SET_SEAT:
      return { ...state, seat: payload.seat }
    default:
      return state
  }
}
