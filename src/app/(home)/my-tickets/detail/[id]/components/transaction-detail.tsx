import { cn, formatString, rupiahFormat } from '@/lib/utils';
        ...
        <div className="flex flex-col gap-[30px] w-[400px]">
            <div className="flex flex-col gap-[18px]">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-bold text-flysha-light-purple">{rupiahFormat(Number(data.price))}</span>
                </div>
                <div className="flex justify-between">
                    <span>Status</span>
