...
export default function PaymentDetail({user}: PaymentDetailProps) {
    ...
    return (
        <div className="flex flex-col gap-[30px] w-[400px]">
            ...
            <button type='button' onClick={payTransaction} disabled={isLoading} className="font-bold text-flysha-black bg-flysha-light-purple rounded-full h-12 w-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#B88DFF] flex justify-center items-center">Checkout with Midtrans</button>
        </div>
    )
}
