        ...
        <>
                                ...
                                <div className="flex flex-col justify-center gap-[14px]">
                                    ...
                                    <div className="flex gap-[10px]">
                                        ...
                                        >
                                            ...
                                            {filter?.map((val, key) => (
                                                <option key={`${key} ${val.departureCity}`} value={val.departureCity}>{val.departureCity}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-center gap-[14px]">
                                    ...
                                    <div className="flex gap-[10px]">
                                        ...
                                        >
                                            ...
                                            {filter?.map((val, key) => (
                                                <option key={`${key} ${val.destinationCity}`} value={val.destinationCity}>{val.destinationCity}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-[10px]">
                        <button className="flex shrink-0 w-10 h-10 items-center justify-center bg-white rounded-full">
                            <Image width={25} height={25} src="/assets/images/icons/arrow-right.svg" className="rotate-180" alt="icon" />
                        </button>
                        <button className="flex shrink-0 w-10 h-10 items-center justify-center bg-white rounded-full">
                            <Image width={25} height={25} src="/assets/images/icons/arrow-right.svg" alt="icon" />
                        </button>
                    </div>
                </div>
            ...
            <footer className="flex flex-col justify-between mt-[150px] border-t-[6px] border-flysha-light-purple p-[100px_10px_30px]">
                <div className="container max-w-[1130px] mx-auto flex justify-between relative">
                    <Image height={300} width={300} src="/assets/images/icons/Ellipse 4.png" className="absolute h-[300px] -top-[45px] -left-[20px] z-0" alt="icon" />
                    <div className="flex shrink-0 h-fit z-10">
                        <Image height={70} width={150} src="/assets/images/logos/logo.svg" alt="" />
                    </div>
                    <div className="flex gap-[100px] z-10">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <Link href="#" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]"><Image height={25} width={25} src="/assets/images/icons/call.svg" alt="icon" />+1 2208 1996</Link>
                            <Link href="#" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]"><Image height={25} width={25} src="/assets/images/icons/dribbble.svg" alt="icon" />buildwithangga</Link>
                            <Link href="#" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]"><Image height={25} width={25} src="/assets/images/icons/sms.svg" alt="icon" />team@bwa.com</Link>
                        </div>
                    </div>
                </div>
